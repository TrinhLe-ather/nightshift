...
const PHASE_COLORS = {
  foundation: { bg: "bg-violet-500/10", text: "text-violet-400", border: "border-violet-500/30", solid: "bg-violet-500" },
  structure: { bg: "bg-sky-500/10", text: "text-sky-400", border: "border-sky-500/30", solid: "bg-sky-500" },
  production: { bg: "bg-amber-500/10", text: "text-amber-400", border: "border-amber-500/30", solid: "bg-amber-500" },
  polish: { bg: "bg-emerald-500/10", text: "text-emerald-400", border: "border-emerald-500/30", solid: "bg-emerald-500" },
} as const;
...
const MOCK_PROJECT: NarrativeProject = {
  ...
  logline: "A black ops team discovers their own government is the enemy, forcing them to become the very terrorists they were hunting.",
  synopsis: "When Delta Force operator Marcus Cole uncovers a conspiracy reaching the highest levels of government, he must go rogue with his team to expose the truth. Hunted by the very forces he once commanded, Marcus navigates a world where every ally could be an enemy, and the line between patriot and terrorist blurs.",
...
const MOCK_DOCUMENTS: NarrativeDocument[] = [
  { id: "doc_1", name: "Story Bible", type: "story_bible", status: "approved", currentVersion: 3, agentId: "story-architect", updatedAt: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(), approvedAt: new Date(Date.now() - 4 * 24 * 60 * 60 * 1000).toISOString() },
  { id: "doc_2", name: "World Bible", type: "world_bible", status: "approved", currentVersion: 2, agentId: "world-builder", updatedAt: new Date(Date.now() - 4 * 24 * 60 * 60 * 1000).toISOString(), approvedAt: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString() },
  { id: "doc_3", name: "Character Bible", type: "character_bible", status: "approved", currentVersion: 4, agentId: "character-architect", updatedAt: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString(), approvedAt: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString() },
  { id: "doc_4", name: "Plot Structure", type: "plot_structure", status: "approved", currentVersion: 2, agentId: "plot-designer", updatedAt: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(), approvedAt: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString() },
  { id: "doc_5", name: "Screenplay", type: "screenplay", status: "generating", currentVersion: 1, agentId: "cinematic-screenwriter", updatedAt: new Date(Date.now() - 30 * 60 * 1000).toISOString() },
  { id: "doc_6", name: "Dialogue Polish", type: "dialogue_polish", status: "not_started", currentVersion: 0, agentId: "dialogue-specialist", updatedAt: new Date(Date.now() - 24 * 60 * 60 * 1000).toISOString() },
  { id: "doc_7", name: "Director's Notes", type: "directors_notes", status: "not_started", currentVersion: 0, agentId: "cinematic-director", updatedAt: new Date(Date.now() - 24 * 60 * 60 * 1000).toISOString() },
  { id: "doc_8", name: "Editorial Report", type: "editorial_report", status: "not_started", currentVersion: 0, agentId: "story-editor", updatedAt: new Date(Date.now() - 24 * 60 * 60 * 1000).toISOString() },
];
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-3">
        ...
        <h3 className={cn("text-sm font-medium", phaseColors.text)}>
          {phaseNames[phase]}
        </h3>
        <span className="text-xs text-muted-foreground">
...
function DocumentPreviewPanel({
  ...
  const versions = document && document.currentVersion > 0
                    ...
                    >
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <Badge
                          ...
                          className={cn("shrink-0 text-xs", statusConfig.bg, statusConfig.text)}
                        >
                          <StatusIcon className={cn("mr-1 h-3 w-3", doc.status === "generating" && "animate-spin")} />
